...
<div class="card" class:shifted>
  <a class="reset-link to-product non-text" href={"/products/" + data.slug} style="background-color: rgb({data.color});">
    <img class="loading" use:showAfterLoaded src={data.image + "-/resize/800x/-/quality/smart/-/progressive/yes/"} alt={data.name} />
  </a>
  <button class="info">
